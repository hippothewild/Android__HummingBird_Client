...
import com.example.week04.adapter.ScrapRowAdapter;
...
public class ScrapActivity extends Activity {
	...
	private ScrapRowAdapter rowAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_scraped);
		
		// Set listview of keywords.
		articleListView = (ListView)findViewById(R.id.scraped_list);
		articleList = new ArrayList<ArticleRowInfo>();
		rowAdapter = new ScrapRowAdapter(this, R.layout.article_row, articleList);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        case R.id.menubutton_scrap:
	        	Log.i("onOptionsItemSelected", "scrap clicked");
	        	break;
	        case R.id.menubutton_logout:
				...
				alert.setPositiveButton("Logout", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						...
						edit.commit();
						Intent intent = new Intent(ScrapActivity.this, LoginActivity.class);
	        ...
	        case R.id.menubutton_settings:
	        	Toast.makeText(ScrapActivity.this, "Setting not implemented!", Toast.LENGTH_SHORT).show();
	        	break;
	        default:
	...
	private void setArticleList()  {
		...
		Cursor cursor = db.rawQuery("SELECT ID, TITLE, NEWS, DATE, CONTENT, LINK, KEYWORD FROM SCRAPS ORDER BY ID DESC;", null);
